...
typedef struct CartesianPose {
  ...
  // Constructor
  CartesianPose() : name("Unnamed Pose") {}
  CartesianPose(const std::string &name_, const Position &pos,
                const Orientation &orient)
      : name(name_), position(pos), orientation(orient) {}
} CartesianPose;
...
typedef struct JointPose {
  ...
  // Constructor
  JointPose() : name("Unnamed Joint Pose"), joint_values(6, 0.0) {}
  JointPose(const std::string &name_, const std::vector<double> &values)
      : name(name_), joint_values(values) {}
} JointPose;
...
typedef struct CartesianOffset {
  ...
  // Constructor
  CartesianOffset() : name("Unnamed Offset") {}
  CartesianOffset(const std::string &name_, const Position &delta_)
      : name(name_), delta(delta_) {}
} CartesianOffset;
